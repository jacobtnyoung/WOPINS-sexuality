...
stargazer( u2.model, u3.model,
           ...
           covariate.labels = c( 
             ...
             "Sexual Acceptance (reversed)-Indegree",
             "Sexual Acceptance (reversed)-Outdegree",
             "Sexual Acceptance (reversed)-Homophily",
             "Age (log)-Indegree",
             "Age (log)-Outdegree",
             "Age (log)-Homophily",
...
THis one works; stuck on trying to get the other one to work also
