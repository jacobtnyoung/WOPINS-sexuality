...
# estimate the model ----
u3.model <- net.f.formula( u3.net, gwideg.val = 1.50, gwesp.val = 0.75, seed.num = 601601 )
...
# build function with formula for ergm ----
net.p.formula <- function( net, gwideg.val, gwesp.val, seed.num ){
  net.terms <- 
    ( net ~ edges 
...
# estimate the model ----
u2.p.model <- net.p.formula( u2.p.net, gwideg.val = 1.25, gwesp.val = 1.00, seed.num = 6016016 )
...
# estimate the model ----
u3.p.model <- net.p.formula( u3.p.net, gwideg.val = 1.25, gwesp.val = 1.00, seed.num = 6016016 )
...
u2.p.model2 <- ergm( u2.p.net ~ edges 
      + twopath + gwidegree( 1.25, fixed=TRUE ) + gwesp( 1.00, fixed = TRUE )
      ...
      + nodeocov( "MentalPhysicalHealth" )
      + absdiff( "MentalPhysicalHealth" ) , 
      control = control.ergm( seed = 6016016, MCMLE.maxit = 1000 ) 
      )
