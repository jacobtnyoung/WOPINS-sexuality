...
The average marginal effect of the `nodeicov.sexacceptance_reverse` term is `r round( accept.ame[1],4 )` with a *p*-value of `r round( accept.ame[4],4 )`. The value of `r round( accept.ame[1],4 )` indicates that the probability of a tie increases by `r round( accept.ame[1],4 )` percent for a 1 unit change in `sexacceptance_reverse`.
